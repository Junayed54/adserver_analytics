...
def publisher_dashboard(request, publisher_id):
    ...
    query_info = f"""
        ...
        LEFT JOIN re_click_server.rv_zones AS z ON p.account_id = z.affiliateid
        LEFT JOIN re_click_server.rv_data_summary_ad_hourly AS s ON s.zone_id = z.zoneid
        LEFT JOIN re_click_server.rv_banners AS b ON b.bannerid = s.ad_id
        LEFT JOIN re_click_server.rv_campaigns AS c ON c.campaignid = b.campaignid
        LEFT JOIN re_click_server.rv_clients AS cl ON cl.clientid = c.clientid
